...
function getDynamoItems(
  fixedParams: AWS.DynamoDB.Types.ScanInput,
  items: AWS.DynamoDB.AttributeMap[] = [],
  lastKey: undefined | AWS.DynamoDB.AttributeMap = undefined
...
function processItem(dynoItem: AWS.DynamoDB.AttributeMap) {
  ...
  cli.question(
    `https://www.itwasnotamanual.com/prediction/${objectVersion.page_url} Action? [None/N (Default), Approve/A, Delete/D]: `,
    async (action) => {
